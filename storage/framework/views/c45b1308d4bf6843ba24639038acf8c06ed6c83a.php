...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <d class="max-w-6xl mx-auto sm:px-6 lg:px-8">
...
<?php /**PATH D:\1I Class Informatics Engineering\POLINEMA CLASS TASK\CLASS Semester 4\Pemprogaman_Web_L\Meet_2\02_praktikum_web_lanjut_dua\resources\views/welcome.blade.php ENDPATH**/ ?>