            ...
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        ...
                        <h2>MIDTERM CRUD (Create, Read, Update, Delete)</h2>
                                ...
                                <table class="table table-bordered" bordercolor="#0f0f0f">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="/goods/<?php echo e($g->id_goods); ?>/edit" class="btn btn-md btn-info mb-3">EDIT</a>
                                            <form action="goods/<?php echo e($g->id_goods); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
...
</html><?php /**PATH D:\1I Class Informatics Engineering\POLINEMA CLASS TASK\CLASS Semester 4\Pemprogaman_Web_L\UTS\PWL_UTS\resources\views/goods/index.blade.php ENDPATH**/ ?>